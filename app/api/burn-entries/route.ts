...
import type { SaveBurnEntryRequest } from "@/lib/types/chat";
...
export async function POST(request: Request) {
  ...
  let body: SaveBurnEntryRequest;
  try {
    body = (await request.json()) as SaveBurnEntryRequest;
  } catch {
  ...
  const insertRow = {
    ...
    exercise_type: exercise_type?.trim() ?? null,
